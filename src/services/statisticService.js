...
// }
function compareDates(d1, d2) {
	// true nếu d1 <= d2, false nếu d1 > d2

	return moment(d1, 'DD/MM/YYYY').isSameOrBefore(moment(d2, 'DD/MM/YYYY'));
}
...
// }
let totalPriceDiscount = (price, discount) => {
	if (discount.voucherData && discount.voucherData.typeVoucherOfVoucherData) {
		if (
